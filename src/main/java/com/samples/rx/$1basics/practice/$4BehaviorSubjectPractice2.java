...
public class $4BehaviorSubjectPractice2 extends AbstractObservers {


    public static void main(String[] args) {

        /**
         * 1- Create a BehaviorSubject
         ...
         *      4-2- Second observer's emits "d","e","f","g","h","i","j"
         *      4-3- Third observer's emits "h","i","j"
         */
